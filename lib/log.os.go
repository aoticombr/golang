...
// Debug Log a message using DEBUG as log level.
...
// Info Log a message using INFO as log level.
...
// Warning Log a message using WARNING as log level.
...
// Error Log a message using ERROR as log level.
...
// Critical Log a message using CRITICAL as log level.
